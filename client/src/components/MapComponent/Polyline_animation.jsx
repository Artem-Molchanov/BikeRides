...
// import {animated_line} from './animated_line.js'

ymaps.ready(['AnimatedLine']).then(init);



//  export default function init(ymaps) {

//     useEffect(() => {
//         const script = document.createElement('script');
//     document.body.appendChild(script);
//     script.setAttribute("text/javascript")
//     script.src = `https://api-maps.yandex.ru/2.1/?apikey=24c18903-4f64-4649-87e4-d2621aa227b9&lang=ru_RU`;
//     script.setAttribute("polyline_animation.js")
//     // script.setAttribute("animated_line.js")
